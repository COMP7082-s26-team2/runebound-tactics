        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center p-6 font-sans">
            <div className="w-full max-w-md bg-[#111111] border border-[#222222] p-8 shadow-2xl">
                <div className="mb-10 text-center">
                    <h1 className="text-3xl font-bold tracking-tighter uppercase mb-2">Register Account</h1>
                    <p className="text-[#666666] text-sm">Join the Runebound Tactics</p>
                </div>
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#111111] px-4 text-[#444444]">Or</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                    ...
                    <form action={signInWithAzure}>
                        <button className="w-full h-11 bg-[#1a1a1a] hover:bg-[#222222] border border-[#333333] flex items-center justify-center transition-colors group">
                            <svg className="w-5 h-5 lg:w-6 lg:h-6" viewBox="0 0 23 23">
